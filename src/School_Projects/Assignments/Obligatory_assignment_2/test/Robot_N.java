...
public class Robot_N {
    private String nameN = "TITO";
    private int batteryLevelN;
    private int distanceToParkN;
    private String botTypeN = "Normal-BOT"; //har ingen egenskaper

    public String reportStatusN() {
        this.nameN = nameN;
        this.batteryLevelN = batteryLevelN;
        this.distanceToParkN = distanceToParkN;
        this.botTypeN = botTypeN;
