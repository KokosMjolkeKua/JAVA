...
public class Robot_Z {
    private String nameZ = "ZOBER";
    private int batteryLevelZ;
    private int distanceToParkZ;
    private String botTypeZ = "Solar-BOT"; //kan lade i sola, men går sakte


    public String reportStatusZ() {
        this.nameZ = nameZ;
        this.batteryLevelZ = batteryLevelZ;
        this.distanceToParkZ = distanceToParkZ;
        this.botTypeZ = botTypeZ;
